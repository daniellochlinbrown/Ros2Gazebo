...
case "$WORLD_NAME" in
  serf)    
    MODEL_POSE="0,0,-3.65,0,0,0"
  ;;
  aspa135_m3) 
    MODEL_POSE="5.05,3.24,32.31,0,0,0" 
  ;;
  bunger)
...
PX4_RUN_CMD="PX4_GZ_STANDALONE=1 PX4_SYS_AUTOSTART=4001 PX4_SIM_MODEL=gz_${MODEL_NAME} PX4_GZ_WORLD=${WORLD_NAME} PX4_GZ_MODEL_POSE=${MODEL_POSE} $PX4_DIR/build/px4_sitl_default/bin/px4"
